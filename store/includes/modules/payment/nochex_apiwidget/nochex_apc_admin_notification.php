...
// display all Nochex status fields (in admin Orders page):
          ...
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_TRANSACTION_ID."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $apc->fields['nc_transaction_id']."\n";
          $output .= '</td></tr>'."\n";
          
          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_TRANSACTION_DATE."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $apc->fields['nc_transaction_date']."\n";
          $output .= '</td></tr>'."\n";
          
          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_TO_EMAIL."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $apc->fields['nc_to_email']."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_FROM_EMAIL."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $apc->fields['nc_from_email']."\n";
          $output .= '</td></tr>'."\n";
          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_ORDER_ID."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $apc->fields['nc_order_id']."\n";
          $output .= '</td></tr>'."\n";
          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_CUSTOM."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $apc->fields['nc_custom']."\n";
          $output .= '</td></tr>'."\n";
          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_AMOUNT."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $apc->fields['nc_amount']."\n";
          $output .= '</td></tr>'."\n";
          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_SECURITY_KEY."\n";
          $output .= '</td><td class="main">'."\n";
          ...
          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_STATUS."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $apc->fields['nc_status']."\n";
          $output .= '</td></tr>'."\n";
          
          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_NOCHEXAPI_ENTRY_NOCHEX_RESPONSE."\n";
          $output .= '</td><td class="main">'."\n";
